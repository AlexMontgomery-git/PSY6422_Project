...
```
## Codebook
The table below highlights the variables that shall be used in the following visualisations and provides an explanation of what each variable is.
